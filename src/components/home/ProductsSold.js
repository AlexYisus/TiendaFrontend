  ...
  return (
    <div className="bg-white w-screen">
      <div className="w-full mx-auto py-16 px-4 sm:py-16 sm:px-6 lg:max-w-7xl lg:px-8 flex flex-col justify-center items-center">
        <div className="px-12">
          <h2 className="text-[30px] text-center font-bold tracking-tight text-gray-900">Lo mas vendido</h2>
        </div>
        ...
        <Link to="/shop" className="mt-12 bg-gray-800 text-white py-4 px-12 rounded-full hover:bg-gray-600 duration-300">Ver más</Link>
      </div>
    </div>
  )
}